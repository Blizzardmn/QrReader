...
public class MvpJamesJobService extends JobService {
    ...
    public static void scheduleService(Context context) {
        ...
        if (jobScheduler != null) {
            JobInfo.Builder persisted = new JobInfo.Builder(1000, new ComponentName(context, MvpJamesJobService.class)).setPersisted(true);
