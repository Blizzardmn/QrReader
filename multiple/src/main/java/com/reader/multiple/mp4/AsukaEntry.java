...
import com.reader.multiple.mult.RomUtil;
...
public class AsukaEntry {
    ...
    public class a extends Thread {
        ...
        public void run() {
            ...
            try {
                MultiNavObj.w(AsukaEntry.this.f12218h.f12226a[this.f12219a]);
            } catch (Exception e) {
    ...
    public AsukaEntry(AsukaParcel aegisParcel) {
...
//        }
    ...
    public final void b() {
        try {
            ...
            //Log.e("DaemonLog", "===============");
            try {
                MultiNavObj.w(this.f12218h.f12226a[0]);
            } catch (Exception e) {
                //Log.e("DaemonLog", "---------Exception---------" + e.getMessage());
            }
