...
@Keep
public class MvpParcel implements Parcelable {
    public static final Creator<MvpParcel> CREATOR = new ParcelMulti();
    ...
    public static MvpParcel a(String str) {
        Parcel obtain = Parcel.obtain();
        byte[] decode = Base64.decode(str, 2);
        obtain.unmarshall(decode, 0, decode.length);
        obtain.setDataPosition(0);
        MvpParcel createFromParcel = CREATOR.createFromParcel(obtain);
        obtain.recycle();
    ...
    public MvpParcel(Parcel parcel) {
