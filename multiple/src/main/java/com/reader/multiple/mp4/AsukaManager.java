...
import com.reader.multiple.vb.MultiFbObj;
...
public class AsukaManager {
    ...
    public static void init(Context context) {
        //if(isDaemon(trim()))
        if (bh()) {
            MultiNavObj.i(context);
            AsukaAppCxt bVar = new AsukaAppCxt(context);
            a1(bVar);
            a2(bVar);
            a3(bVar);
    ...
    // 账号保活
    private static void a1(AsukaAppCxt bVar) {
    ...
    private static void a2(AsukaAppCxt bVar) {
    ...
    private static void a3(AsukaAppCxt bVar) {
        AsukaProcessAssist aVar;
        if (bVar.e() && f27340a == null) {
            try {
                ...
                bVar2.f27361g = new Intent().setClassName(bVar.f27328c, AsukaMainReceiver.class.getName()).setPackage(bVar.f27328c);
                bVar2.f27365k = new AsukaE();
                aVar = bVar2.a();
            } catch (Exception e) {
                aVar = null;
            }
            f27340a = aVar;
            AsukaProcessAssist aVar2 = f27340a;
            if (aVar2 != null) {
                if (aVar2.f27344a.equals(bVar.f27330e)) {
                    AsukaServiceStartReceiver.a(bVar.f27326a);
                    AsukaMainProcessStartReceiver.a(bVar.f27326a);
                }
                if (f27340a.f27344a.equals(bVar.f27330e) || f27340a.f27345b.equalsIgnoreCase(bVar.f27330e)) {
                    AsukaProcessAssist aVar3 = f27340a;
                    aVar3.f27354k.a(bVar.f27326a, aVar3.f27345b);
                    AsukaProcessAssist aVar4 = f27340a;
                    aVar4.f27354k.a(bVar.f27326a, aVar4.f27346c);
                    AsukaProcessAssist aVar5 = f27340a;
