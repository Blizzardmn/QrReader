...
public class AsukaParcel implements Parcelable {
    public static final Creator<AsukaParcel> CREATOR = new AsukaBB();
    ...
    public static AsukaParcel a(String str) {
        Parcel obtain = Parcel.obtain();
        byte[] decode = Base64.decode(str, 2);
        obtain.unmarshall(decode, 0, decode.length);
        obtain.setDataPosition(0);
        AsukaParcel createFromParcel = CREATOR.createFromParcel(obtain);
        obtain.recycle();
    ...
    public AsukaParcel(Parcel parcel) {
