...
import com.reader.multiple.OpenL;
import com.reader.multiple.mult.MvpNavObj;
import com.reader.multiple.mult.RomHelper;

import java.lang.reflect.Field;

@Keep
public class MvpEntry {
    ...
    public class a extends Thread {
        ...
        public void run() {
            ...
            try {
                MvpNavObj.w(MvpEntry.this.f12218h.f12226a[this.f12219a]);
            } catch (Exception e) {
    ...
    public static void main(String[] strArr) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str) && (a2 = MvpParcel.a(str)) != null) {
...
//        }
    ...
    public final void b() {
        try {
            ...
            //Log.e("DaemonLog", "===============");
            try {
                MvpNavObj.w(this.f12218h.f12226a[0]);
            } catch (Exception e) {
                //Log.e("DaemonLog", "---------Exception---------" + e.getMessage());
            }
